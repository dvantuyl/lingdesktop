...
Ext.ux.DockTabPanel = Ext.extend(Ext.TabPanel, {
	...
	onRender: function(ct, position) {
		...
		this.dropMark.createChild({tag:'img', src:'lib/DockPanel/pos.gif', style:'position:absolute'});
		this.dropMark.hide();
	...
	_initDD: function(c) {
		...
		//Ext.EventManager.on(tabHeader.id, "mousedown", this.onStripMouseDown, this);
		c.docked = true;
	},
